...
namespace Microsoft.AspNetCore.Server.Kestrel.Https
{
    ...
    public class TlsHandshakeCallbackOptions
    {
        ...
        /// </summary>
        /// <param name="onConnection">The callback to invoke per connection.</param>
        public TlsHandshakeCallbackOptions(Func<TlsHandshakeCallbackContext, ValueTask<SslServerAuthenticationOptions>> onConnection)
        {
            if (onConnection is null)
            {
                throw new ArgumentNullException(nameof(onConnection));
            }
        ...
        /// <summary>
        /// The callback to invoke per connection.
        /// </summary>
        public Func<TlsHandshakeCallbackContext, ValueTask<SslServerAuthenticationOptions>> OnConnection { get; }
